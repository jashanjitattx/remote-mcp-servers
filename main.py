...
import os
import aiosqlite  # Changed: sqlite3 → aiosqlite this is for performing asynchronous DB operations
import tempfile
...
async def add_expense(date, amount, category, subcategory="", note=""):  # Changed: added async
    '''Add a new expense entry to the database.this operation will be asynchronous'''
    try:
